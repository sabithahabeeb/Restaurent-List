...
function Footer() {
  return (
    <div className='d-flex justify-content-center align-items-center bg-light flex-column ' style={{ width: '100%', height: '300px', color: 'white' }}>
    <div className="footer-content d-flex justify-content-evenly w-100 flex-wrap">
        <div className="website" style={{ width: '300px' }}>
            <h4><i className="fa-solid fa-truck-fast me-2"></i>{' '}Restaurent List</h4>
            ...
            <div >
                <div>
                    ...
                    <div>
                        ...
                        <button className="bg-primary" style={{ width: '40px', height: '40px', borderRadius: '10px', margin: '10px' }}><i class="fa-solid fa-arrow-right"></i></button>
                    </div>
    ...
    <div> <p>Copyright © 2023 Restaurent List. Built with Docusaurus.</p></div>
</div>
  )
}
